...
export default function Home() {
 const [showDiv, setShowDiv] = useState(true);
   //  const [clsNameDiv, setClsNameDiv] = useState("hamburger");
   //  const [clsNameUL, setClsNameUL] = useState("navMenu");
     ...
     <section className={styles.header}>
      <div className={styles.headerText}>
       ...
       <p>
        ...
        aliquid magnam repellat, quaerat, deserunt eveniet nobis perspiciatis
        rum impedit unde consectetur adipisicing.
       </p>
